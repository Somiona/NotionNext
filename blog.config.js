...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '145fcc8c553b8019af20ca7259950094,en:145fcc8c553b8019af20ca7259950094',
  ...
  GREETING_WORDS:
    ...
    'Hello World, Be Foxy🦊, Eat Well Sleep Well Code Well, Layback.',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Somiona', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一只狐狸🦊', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.somiona.com', // 网站地址
